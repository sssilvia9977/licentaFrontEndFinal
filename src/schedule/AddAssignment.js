...
export default function ({courseName, sessionFromBack, navigation, hideOverlay, assignments, setAssignments}) {
    ...
    return (
        <View style={styles.container}>
            ...
            <View>
                <Text style={{fontWeight: 'bold', color: "#698a96", paddingTop: 30, fontSize: 15}}> Choose
                    deadline</Text>
                <DatePicker
            ...
            <TouchableOpacity
                style={[commonStyle.commonButton, {marginTop: 50,  backgroundColor: disabled ? colors.gray : colors.myPink }]}
